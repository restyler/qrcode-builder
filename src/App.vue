...
<div class="min-h-screen flex flex-col items-center justify-center bg-gray-300">
  <div class="flex flex-row shadow-md bg-white rounded-md mt-20 w-full max-w-6xl">
    <div class="flex flex-col border border-r-1  px-4 sm:px-6 md:px-8 lg:px-10 py-8  w-1/2 max-w-md">
        <div class="font-medium self-center text-xl sm:text-2xl uppercase text-gray-800">Build your supercharged QR code</div>
          ...
          <form @submit.prevent="generate()">
            <div class="flex flex-col mb-6">
                ...
                <div class="relative">
                    ...
                    <input id="text" v-model="secretKey" type="text" class="text-sm sm:text-base placeholder-gray-500 px-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400" placeholder="Key" />
                </div>
            ...
            <div class="relative">
                ...
                <input id="text" v-model="options.logo_url" type="text" class="text-sm sm:text-base placeholder-gray-500 px-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400" placeholder="https://some-site/logo.png"/>
      ...
      <div class="flex flex-col  px-4 sm:px-6 md:px-8 lg:px-10 py-8  w-1/2 max-w-lg">
        ...
        <div v-if="needRegeneration" class="mt-4 fixed right-0 bottom-0 m-5">
        ...
        <div v-if="isReadable" class="px-4 py-3 my-4  text-sm text-gray-600 bg-gray-100 rounded-lg">
            <a href="#" class="text-indigo-600"  @click.prevent="download()">Download as {{ generatedImgFormat.toUpperCase() }} 
                ({{ (generatedImgBlob.length/1024).toFixed() }}KB) </a>
      ...
      methods: {
        ...
        draw(imgBase64) {
            ...
            image.onload = function() {
                ...
                //console.log('width:',image.height);
